...
@section('content')
    <!-- Hero Section -->
    <section class="bg-gradient-to-r from-green-50 to-white py-5 px-8 flex flex-col md:flex-row items-center justify-between">
        <!-- Text Content -->
        <div class="md:w-1/2 mb-12 md:mb-0">
            <h1 class=" text-3xl md:text-5xl font-extrabold text-gray-700 leading-tight">
                The Smartest Way to <span class="text-green-600">Manage PDFs</span>
            </h1>
            ...
            <div class="mt-6 flex flex-wrap gap-4">
                ...
                <a href="{{ route('home.AllTools') }}"
                    class="border border-green-600 text-green-600 font-semibold
                                  px-4 py-2 text-sm
                                  sm:px-6 sm:py-2.5 sm:text-base
                                  md:px-8 md:py-3 md:text-lg
                                  rounded-lg
    ...
    <section class="py-20 bg-gray-50 text-center">
        <div class="max-w-6xl mx-auto px-6">
            <h2 class="text-4xl font-extrabold text-gray-700 mb-4">Most Popular PDF Tools</h2>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                ...
                <a href="{{ route('pdf-to-zip') }}">
                    <div
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-700">PDF to ZIP</h3>
                ...
                <a href="{{ route('pdf-to-doc') }}">
                    <div
                        class="flex items-start bg-white shadow-lg border border-gray-200 rounded-xl p-6 text-left hover:shadow-xl transition">
                        <div class="bg-green-100 text-green-500 rounded-full p-3 mr-4">
                            <i class="fas fa-file-word text-2xl"></i>
                        </div>
                        <div>
                            <h3 class="font-semibold text-gray-700">PDF to DOC</h3>
                ...
                <a href="{{ route('pdf-to-jpg') }}">
                    <div
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-700">PDF to JPG</h3>
                ...
                <a href="{{ route('jpg-to-png') }}">
                    <div
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-700">JPG to PNG</h3>
                ...
                <a href="{{ route('background-change') }}">
                    <div
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-700">Background Remover</h3>
                ...
                <a href="{{ route('resume.index') }}">
                    <div
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-700">Resume Maker</h3>
                ...
                <a href="{{ route('merge-pdf') }}">
                    <div
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-700">Merge PDF</h3>
                ...
                <a href="{{ route('split-pdf') }}">
                    <div
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-700">Split PDF</h3>
                ...
                <a href="{{ route('delete-pdf-pages') }}">
                    <div
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-700">Delete PDF Pages</h3>
            ...
            <div class="mt-12">
                <a href="{{ route('home.AllTools') }}"
                    class="inline-block underline text-green-600 px-6 py-3 rounded-lg font-semibold hover:bg-text-700 transition">
    ...
    <section class="py-20 bg-gray-50">
        <div class="max-w-6xl mx-auto px-6 text-center">
            <h2 class="text-4xl font-extrabold text-gray-700 mb-4">Why Choose CraftMyDoc?</h2>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <h3 class="text-xl font-semibold text-gray-700 mb-2">Fast & Secure</h3>
                ...
                <div
                    ...
                    <h3 class="text-xl font-semibold text-gray-700 mb-2">Works on Any Device</h3>
                ...
                <div
                    ...
                    <h3 class="text-xl font-semibold text-gray-700 mb-2">Free to Use</h3>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-6xl mx-auto px-6">
            <h2 class="text-4xl font-extrabold text-gray-700 text-center mb-10">Frequently Asked Questions</h2>

            <div class="space-y-6">
                <div class="p-6 border border-gray-300 rounded-lg shadow-sm transition hover:shadow-md">
                    <h3 class="text-lg font-semibold text-gray-700">Is CraftMyDoc free to use?</h3>
                    <p class="text-gray-600 mt-2">Yes! You can access most of our tools for free with limited features.</p>
                </div>

                <div class="p-6 border border-gray-300 rounded-lg shadow-sm transition hover:shadow-md">
                    <h3 class="text-lg font-semibold text-gray-700">Do I need to install any software?</h3>
                    <p class="text-gray-600 mt-2">No, CraftMyDoc works entirely online from your browser.</p>
                </div>

                <div class="p-6 border border-gray-300 rounded-lg shadow-sm transition hover:shadow-md">
                    <h3 class="text-lg font-semibold text-gray-700">Is my data secure?</h3>
